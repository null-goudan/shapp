# Generated by Django 3.2.5 on 2021-09-01 13:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classify', models.CharField(default='未知', max_length=32, verbose_name='单子类型')),
                ('goods', models.CharField(default='', max_length=32, verbose_name='物品')),
                ('get_address', models.CharField(default='', max_length=50, verbose_name='取货地址')),
                ('home_address', models.CharField(default='', max_length=50, verbose_name='收货地址')),
                ('phone', models.CharField(default='', max_length=32, verbose_name='电话')),
                ('date_start', models.DateTimeField(auto_now=True, verbose_name='开始时间')),
                ('date_ending', models.DateTimeField(auto_now=True, verbose_name='截止时间')),
                ('back', models.IntegerField(default=0, verbose_name='回报')),
                ('BackType', models.BooleanField(default=False, verbose_name='回报类型')),
                ('describe', models.TextField(default='', max_length=200, verbose_name='详细需求/备注')),
